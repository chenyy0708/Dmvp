 ...
 */
package com.horen.avbobo.di.component;
 ...
 * @author :ChenYangYi
 * @date :2018/4/24
 * @description : 导航 Fragment Component
 */
@FragmentScope
@Component(modules = AvboboModule.class, dependencies = AppComponent.class)
public interface AvboboComponent {
    void inject(AvboboFragment fragment);
}
